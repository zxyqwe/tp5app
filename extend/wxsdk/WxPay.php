...
abstract class WxPayConfigInterface
{
    ...
    /**
     * TO DO：这里设置代理机器，只有需要代理的时候才设置，不需要代理，请设置为0.0.0.0和0
    ...
    /**
     * TO DO：接口调用上报等级，默认紧错误上报（注意：上报超时间为【1s】，上报无论成败【永不抛出异常】，
 ...
 *
 */
abstract class WxPayNotify extends WxPayNotifyReply
{
    private $config = null;
     ...
     */
    //TO DO 用户基础该类之后需要重写该方法，成功的时候返回true，失败返回false
    abstract public function NotifyProcess($objData, $config, &$msg);
